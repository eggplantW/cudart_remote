...
private:
	...
	void SendData() {
		...
		mpi_error( MPI_Isend(m_HostSendBufQue[m_HostSendBufQueFront], m_HostSendCount[m_HostSendBufQueFront], MPI_BYTE, m_SrcProc, m_HostSendTag[m_HostSendBufQueFront], m_Comm,m_SendReq + m_HostSendBufQueFront) );
